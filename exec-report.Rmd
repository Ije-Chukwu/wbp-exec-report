...
```{r fgm-percentage-plot, echo=FALSE, message=FALSE, warning=FALSE}
# Read data
...
- USAID
- LMICs
- All IPUMS Variable abbreviations available on [IPUMS-DHS](https://www.idhsdata.org/idhs-action/variables/group).
