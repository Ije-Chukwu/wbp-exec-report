...
# EXECUTIVE REPORT (PART A): PROFESSIONAL WORK BASED PLACEMENT IN HEALTH DATA SCIENCE SCIENCE
...
```{r read-clean-data, echo=TRUE, message=FALSE, warning=FALSE}
# Read data
...
```{r rename-cols-del-missing-niu-total, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r ipv-percentage-plot, echo=TRUE, message=FALSE, warning=FALSE}
library(plotly)
library(forcats)
...
```{r ipv-plot-img, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r fgm-percentage-plot,echo=TRUE, message=FALSE, warning=FALSE}
# Read data
...
```{r fgm-plot-img, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r ahcdm-plot-img, echo=TRUE, message=FALSE, warning=FALSE}
...
*Abbreviations* - DHS - IPUMS - USAID - LMICs - All IPUMS Variable abbreviations available on [IPUMS-DHS](https://www.idhsdata.org/idhs-action/variables/group).
