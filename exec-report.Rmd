...
```{r read-clean-data, include=FALSE}
# Read data
...
```{r rename-cols-del-missing-niu-total, include=FALSE}
...
```{r ipv-percentage-plot, echo=FALSE, message=FALSE, warning=FALSE}
library(plotly)
library(forcats)
...
```{r fgm-percentage-plot, message=FALSE, warning=FALSE, include=FALSE}
# Read data
...
```{r ahcdm-percentage-plot, echo=FALSE, message=FALSE, warning=FALSE}
library(plotly)
library(forcats)
...
```{r ahcdm-plot-img, echo=TRUE, warning=FALSE}
